...
class VGG(nn.Module):
    ...
    def __init__(self, features, num_classes=952):
        ...
        self.classifier = nn.Sequential(
            nn.Linear(512 * 2 * 2, 4096),  # Điều chỉnh kích thước đầu vào
            nn.ReLU(inplace=True),
            nn.Dropout(),
            nn.Linear(4096, 4096),
            nn.ReLU(inplace=True),
            nn.Dropout(),
            nn.Linear(4096, num_classes)  # Điều chỉnh số lượng lớp
        )
